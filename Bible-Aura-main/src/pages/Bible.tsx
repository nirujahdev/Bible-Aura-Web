...
export default function Bible() {
  ...
  return (
    <PageLayout padding="none" maxWidth="full">
      ...
      {/* Full-Width Header */}
      <div className="bg-gradient-to-r from-orange-500 to-amber-500/90 text-white border-b sticky top-0 z-10 backdrop-blur-md bg-opacity-95">
                      ...
                      return (
                        ...
                        >
                          <div className="flex items-start gap-5">
                            ...
                            {/* Action Buttons */}
                            <div className="bible-verse-actions flex items-center gap-2 opacity-100 xs:opacity-0 xs:group-hover:opacity-100 transition-opacity duration-200">
                              {/* Favorite */}
                              <Button
                                variant="ghost"
                                size="icon"
                                onClick={() => toggleFavorite(verse)}
                                className="p-0 touch-target"
