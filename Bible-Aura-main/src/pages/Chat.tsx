...
// Function to call Biblical AI with enhanced biblical focus and abort support
      ...
      <div className="min-h-screen bg-background flex flex-col w-full">
        ...
        <div className="flex-1 flex flex-col min-w-0 w-full">
          <div className="flex flex-col h-full w-full">
            ...
            {/* Messages Area */}
            <ScrollArea className="flex-1 p-3 sm:p-4 w-full" ref={scrollAreaRef}>
              {messages.length === 0 ? (
            ...
            <div className="border-t p-3 sm:p-4 bg-gray-50 flex-shrink-0">
              <div className="flex gap-2 w-full max-w-4xl mx-auto">
                ...
                {isLoading ? (
                  <Button
                    onClick={stopMessage}
                    className="bg-red-500 hover:bg-red-600 flex-shrink-0 px-3 sm:px-4"
                  >
                  ...
                  <Button
                    onClick={sendMessage}
                    disabled={!input.trim()}
                    className="bg-primary hover:bg-primary/90 flex-shrink-0 px-3 sm:px-4"
                  >
