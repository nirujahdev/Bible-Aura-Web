    ...
    <div className="lg:hidden">
      <Sheet open={open} onOpenChange={setOpen}>
        ...
        <SheetContent side="left" className="w-[320px] p-0 bg-white">
          ...
          <div className="p-4 sm:p-6 bg-gradient-to-r from-primary to-primary/90 text-white">
    ...
    <>
      ...
      <div className="lg:hidden">
        <Dialog open={mobileOpen} onOpenChange={setMobileOpen}>
          ...
          <DialogContent className="w-[320px] p-0 bg-white max-w-none">
            {/* Enhanced Mobile Header */}
            <div className="p-4 sm:p-6 bg-gradient-to-r from-primary to-primary/90 text-white">
              <div className="text-center">
                <div className="inline-flex items-center justify-center w-12 h-12 bg-white/20 rounded-xl mb-3 backdrop-blur-sm">
      ...
      <Sidebar 
        className={`border-r border-gray-200 bg-white transition-all duration-300 flex-shrink-0 ${
          !isExpanded ? 'w-16' : 'w-64 lg:w-72'
        } ${isHovered && !isExpanded ? 'w-64 lg:w-72' : ''}`}
