...
export default function Auth() {
  ...
  const { user, session, signIn, signInWithGoogle, signUp, loading } = useAuth();
  ...
  const features = [
    ...
    },
    {
      ...
      description: "Receive personalized devotionals, prayer suggestions, and spiritual growth recommendations based on your reading.",
  ...
  useEffect(() => {
    ...
    if (hasError) {
      ...
      console.log('OAuth callback detected', { isOAuthCallback });
          ...
          <Card className="shadow-xl bg-white/95 backdrop-blur-sm border-white/20 w-full">
            ...
            <CardContent className="px-4 sm:px-6 pb-4">
              ...
              <Tabs value={currentTab} onValueChange={setCurrentTab} className="w-full">
                <TabsList className="grid w-full grid-cols-2 bg-primary/10 border border-primary/20 h-10 mb-4">
