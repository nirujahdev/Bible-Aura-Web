...
export default function Auth() {
  ...
  useEffect(() => {
    ...
    if (!loading && user) {
      ...
      // Determine final redirect destination - go to main app unless specific redirect
          ...
          <Card className="shadow-xl bg-white/95 backdrop-blur-sm border-white/20 w-full">
            ...
            <CardContent className="px-4 sm:px-6 pb-4">
              ...
              <Tabs value={currentTab} onValueChange={setCurrentTab} className="w-full">
                <TabsList className="grid w-full grid-cols-4 bg-primary/10 border border-primary/20 h-10 mb-4">
