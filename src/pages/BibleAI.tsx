  ...
  const sendMessage = async (messageText?: string) => {
    ...
    setTimeout(() => {
      const aiMessage: Message = {
        ...
        role: 'assistant',
        content: `Thank you for your question: "${textToSend}". I'm here to help you explore Biblical truths and deepen your understanding of Scripture. How can I assist you further in your spiritual journey?`,
        timestamp: new Date().toLocaleString()
      };
                ...
                {isLoading && (
                  <div className="flex gap-4 justify-start">
                    ...
                    <div className="max-w-2xl">
                      <div className="bg-white text-gray-900 rounded-2xl rounded-bl-md border border-gray-200 shadow-sm p-4">
                        <div className="flex items-center space-x-2">
                          ...
                          <span className="text-sm text-gray-500">Bible Aura AI is thinking...</span>
                        </div>
                      </div>
                    </div>
                  </div>
