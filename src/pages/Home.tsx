...
const Home = () => {
  ...
  return (
    <div className="min-h-screen bg-background w-full">
      ...
      {/* Hero Section with Phone Animation - Enhanced Mobile Responsiveness */}
      <section className="relative py-12 md:py-20 px-4 md:px-6 lg:px-10 bg-gradient-to-br from-gray-50 via-white to-orange-50 overflow-hidden pt-24 md:pt-32">
        ...
        <div className="relative w-full max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            <div className="text-center lg:text-left flex flex-col justify-center order-1">
              ...
              {/* Main Title */}
              <h1 className="text-3xl md:text-4xl lg:text-6xl font-bold mb-6 md:mb-8 leading-tight px-4 md:px-0">
                <span className="text-transparent bg-gradient-to-r from-orange-500 to-orange-600 bg-clip-text">
                  AI-Powered Biblical Insight
                </span>
              </h1>
              
              <p className="text-base md:text-lg lg:text-xl text-gray-600 max-w-2xl mx-auto lg:mx-0 leading-relaxed mb-6 md:mb-8 px-4 md:px-0">
              ...
              <div className="flex justify-center lg:justify-start px-4 md:px-0">
                <Button asChild size="lg" className="bg-gradient-to-r from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700 text-white text-base md:text-lg px-6 md:px-8 py-4 md:py-6 rounded-xl shadow-lg animate-pulse w-full sm:w-auto">
                  <Link to="/auth">
            ...
            <div className="relative flex justify-center order-2 mb-8 lg:mb-0">
              ...
              <div className="relative">
                {/* Phone Frame */}
                <div className="relative w-72 md:w-80 h-[500px] md:h-[600px] bg-black rounded-[2.5rem] md:rounded-[3rem] p-1.5 md:p-2 shadow-2xl">
                  <div className="w-full h-full bg-white rounded-[2rem] md:rounded-[2.5rem] overflow-hidden relative">
                    ...
                    {/* Chat Messages */}
                    <div className="p-3 md:p-4 space-y-3 md:space-y-4 h-[380px] md:h-[480px] overflow-hidden">
                      {/* User Message */}
                      <div className="flex justify-end animate-slideInRight">
                        <div className="bg-orange-500 text-white p-2 md:p-3 rounded-2xl rounded-br-md max-w-xs">
                      ...
                      <div className="flex justify-start animate-slideInLeft animation-delay-1000">
                        <div className="bg-gray-100 text-gray-800 p-2 md:p-3 rounded-2xl rounded-bl-md max-w-xs">
                      ...
                      <div className="flex justify-start animate-pulse animation-delay-2000">
                        <div className="bg-gray-100 p-2 md:p-3 rounded-2xl rounded-bl-md">
                          <div className="flex space-x-1">
                            <div className="w-1.5 md:w-2 h-1.5 md:h-2 bg-gray-400 rounded-full animate-bounce"></div>
                            <div className="w-1.5 md:w-2 h-1.5 md:h-2 bg-gray-400 rounded-full animate-bounce animation-delay-200"></div>
                            <div className="w-1.5 md:w-2 h-1.5 md:h-2 bg-gray-400 rounded-full animate-bounce animation-delay-400"></div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="flex justify-start animate-slideInLeft animation-delay-4000">
                        <div className="bg-gray-100 text-gray-800 p-2 md:p-3 rounded-2xl rounded-bl-md max-w-xs">
                          ...
                          <p className="text-xs mt-1 md:mt-2 text-blue-600">• Jeremiah 29:11</p>
                    ...
                    {/* Input Area */}
                    <div className="absolute bottom-0 left-0 right-0 p-3 md:p-4 bg-white border-t">
                      <div className="flex items-center gap-2">
                        ...
                        <div className="w-8 md:w-10 h-8 md:h-10 bg-orange-500 rounded-full flex items-center justify-center">
                          <Send className="h-3 md:h-4 w-3 md:w-4 text-white" />
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                {/* Floating Elements Around Phone - Hidden on small mobile */}
                <div className="hidden sm:block absolute -top-4 -right-4 w-10 md:w-12 h-10 md:h-12 bg-orange-100 rounded-full flex items-center justify-center animate-bounce animation-delay-500">
                  <Zap className="h-5 md:h-6 w-5 md:w-6 text-orange-600" />
                </div>
                <div className="hidden sm:block absolute -bottom-4 -left-4 w-10 md:w-12 h-10 md:h-12 bg-blue-100 rounded-full flex items-center justify-center animate-bounce animation-delay-1000">
                  <BookOpen className="h-5 md:h-6 w-5 md:w-6 text-blue-600" />
                </div>
                <div className="hidden md:block absolute top-1/2 -left-8 w-8 h-8 bg-purple-100 rounded-full flex items-center justify-center animate-pulse">
      ...
      <footer className="bg-black text-white py-12 md:py-16">
        <div className="w-full px-4 sm:px-6 lg:px-12">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 text-center md:text-left">
            ...
            {/* Menu Section */}
            <div className="text-center md:text-left">
              <h4 className="text-lg md:text-xl font-semibold text-white mb-4 md:mb-6">Menu</h4>
              <nav className="space-y-2 md:space-y-3">
                <Link to="/about" className="block text-gray-400 hover:text-orange-400 transition-colors duration-300 text-sm md:text-base">
                  About
                </Link>
                <Link to="/careers" className="block text-gray-400 hover:text-orange-400 transition-colors duration-300 text-sm md:text-base">
                  Careers
                </Link>
                <Link to="/chat" className="block text-gray-400 hover:text-orange-400 transition-colors duration-300 text-sm md:text-base">
                  AI Chat
                </Link>
                <Link to="/auth" className="block text-gray-400 hover:text-orange-400 transition-colors duration-300 text-sm md:text-base">
                  Sign In
                </Link>
              </nav>
            </div>
            ...
            {/* Contact Section */}
            <div className="text-center md:text-left">
              <h4 className="text-lg md:text-xl font-semibold text-white mb-4 md:mb-6">Contact</h4>
              <div className="space-y-2 md:space-y-3">
                <p className="text-gray-400 text-sm md:text-base">@bible_aura.ai</p>
                <a 
                  href="mailto:bibleaura.contact@gmail.com" 
                  className="block text-gray-400 hover:text-orange-400 transition-colors duration-300 text-sm md:text-base"
                >
